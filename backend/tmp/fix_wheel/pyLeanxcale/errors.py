...
class SerializationError(DatabaseError):
    """Raised when running query engine server using different serialization than PROTOBUF"""

class ArrayTypeException(Error):
    """Raised when used a type not supporteb for the arrays"""
