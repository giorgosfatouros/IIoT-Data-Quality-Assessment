...
from pyLeanxcale import errors
from pyLeanxcale import typessOld
from pyLeanxcale.client import AvaticaClient
from pyLeanxcale.connection import Connection
from pyLeanxcale.errors import *
from pyLeanxcale.typessOld import *

__all__ = ['connect', 'apilevel', 'threadsafety', 'paramstyle'] + typessOld.__all__ + errors.__all__
...
def connect(url, max_retries=None, **kwargs):
    """Connects to a LeanXcale query server.
    ...
    """
    client = AvaticaClient(url, 5, None, **kwargs)
    client.connect()
