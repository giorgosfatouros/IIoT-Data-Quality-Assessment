...
import uuid
import weakref
from pyLeanxcale import errorsOld
from pyLeanxcale.client import OPEN_CONNECTION_PROPERTIES
from pyLeanxcale.cursor import Cursor
from pyLeanxcale.errors import ProgrammingError
...
class Connection(object):
    ...
    def set_session(self, autocommit=None, readonly=None, useTZ=False):
        ...
        :param useTZ:
            False by default. If useTZ, use localTime of client. Else, use UTC/GMT
        """
        props = {}
